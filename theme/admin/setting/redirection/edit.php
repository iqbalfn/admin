                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <a href="<?= base_url('/admin/setting/redirection/' . $url->id . '/remove') ?>" class="btn btn-danger btn-confirm" data-title="<?= _l('Delete Confirmation') ?>" data-confirm="<?= hs(_l('Are you sure want to delete this redirection permanently?')) ?>"><?= _l('Delete') ?></a>
                                <?php endif; ?>
                            </div>
