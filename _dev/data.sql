...
INSERT INTO `perms` ( `group`, `name`, `label`, `description` ) VALUES
    ...
    ( 'Post',               'delete-post_other_user',   'Delete Other Reporter Post',   'Allow user to remove other reporter posts' ),
    ( 'Post',               'read-post_other_user',     'Read Other Reporter Post',     'Allow user to see other reporter posts' ),
